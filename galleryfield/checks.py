...
PROMPT_ALERT_IF_CHANGED_ON_WINDOW_RELOAD = "prompt_alert_if_changed_on_window_reload"

JQUERY_FILE_UPLOAD_UI_DEFAULT_OPTIONS = "jquery_file_upload_ui_options"
...
def check_settings(app_configs, **kwargs):
                        ...
                        DJGalleryCriticalCheckMessage(
                            msg=(
                                ...
                                % {
                                    ...
                                    % (EXTRA_JS, ASSETS, DJANGO_GALLERY_FIELD_CONFIG),
                                    "types": "str",
                                }
                            ),
                    ...
                    errors.append(
                        DJGalleryCriticalCheckMessage(
                            msg=(
                                ...
                                % {
                                    "location": "'%s' in '%s' in '%s'"
                                    % (EXTRA_CSS, ASSETS, DJANGO_GALLERY_FIELD_CONFIG),
                                    "types": "str",
                                }
                            ),
            ...
            for asset_name, asset_value in assets_copy.items():
                if asset_name not in (
                    ...
                    errors.append(
                        checks.Warning(
                            msg=(
                                "%(location)s is not in the required assets, it"
                ...
                if asset_value is None:
                    errors.append(
                        checks.Warning(
                            msg=(
                                "%(location)s is set to None, that might "
    ...
    if thumbnails is not None:
        if not isinstance(thumbnails, dict):
            ...
            try:
                get_formatted_thumbnail_size(thumbnail_size, name=THUMBNAIL_SIZE)
                            ...
                            DJGalleryCriticalCheckMessage(
                                msg=(
                                    ...
                                    % {
                                        ...
                                        "error_str": "Thumbnail quality should be "
                                        "between 0 and 100",
                                    }
                                ),
        ...
        if not isinstance(jfu_options, dict):
            ...
            if MAX_NUMBER_OF_FILES in jfu_options:
                errors.append(
                    checks.Warning(
                        msg=(
                            "%(location)s will be ignored, that is configured in "
            ...
            if (
                SINGLE_FILE_UPLOADS in jfu_options
                ...
                errors.append(
                    checks.Warning(
                        msg=(
                            "%(location)s set to False is not allowed and will"
                            "be ignored. "
                            % {
                                "location": (
                                    "option '%s' in '%s' in '%s'"
            ...
            if PREVIEW_MAX_WIDTH in jfu_options or PREVIEW_MAX_HEIGHT in jfu_options:
                errors.append(
                    checks.Warning(
                        msg=(
                            "%(location)s will be ignored. By preview size, we mean "
